...
<head runat="server">
  ...
  <script type="text/javascript">
    ...
    // Patch
    function fixJapaneseSafari(){
      Telerik.Web.UI.RadEditor.prototype.isKeyEventComposed = function (e) {
          e = e.rawEvent || e.originalEvent || e;
          //debugger;
          if (Telerik.Web.Browser.safari) return true;
          return e.key == "Process" || ("locale" in e && /^(ja|ko|zh)/.test(e.locale));
      }
    }
